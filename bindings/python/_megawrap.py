...
# think about MegaApi.login since its pretty much the same
...
# Think about MegaApi.remove. its already sounds fine
MegaApi.send_file_to_user = MegaApi.sendFileToUser
# Think about MegaApi.share
