...
class Mega_Api_Python(MegaApi):
    ...
    def add_listener_test(self):
        ...
        '''
        self.addListener(self.create_delegate_mega_listener())
...
# Mirroring, WILL BE MOVED TO Mega_Api_Python class later
